...
export default function Cards() {
  return (
    <div className="animate-fade-up grid mt-[20px] grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
      <div className="flex-shrink-0 m-6 relative overflow-hidden bg-[#f87171] rounded-lg max-w-xs shadow-2xl">
      ...
      <div className="relative text-white px-6 pb-6 mt-6">
        ...
        <div className="flex justify-between">
          ...
          <Link href="/comercial">
          <span className="block bg-white rounded-full text-[#f87171] hover:bg-[#f87171] hover:text-white text-xs font-bold px-3 py-2 leading-none flex items-center">Ingresar</span>
          </Link>
        </div>
      </div>
    </div>
    <div className="flex-shrink-0 m-6 relative overflow-hidden bg-[#c084fc] rounded-lg max-w-xs shadow-2xl">
      <svg className="absolute bottom-0 left-0 mb-8 scale-150 opacity-10" viewBox="0 0 375 283" fill="none">
        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white"/>
        <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white"/>
      </svg>
    ...
    <div className="flex-shrink-0 m-6 relative overflow-hidden bg-[#60a5fa] rounded-lg max-w-xs shadow-2xl">
      <svg className="absolute bottom-0 left-0 mb-8 scale-150 opacity-10" viewBox="0 0 375 283" fill="none">
        <rect x="159.52" y="175" width="152" height="152" rx="8" transform="rotate(-45 159.52 175)" fill="white"/>
        <rect y="107.48" width="152" height="152" rx="8" transform="rotate(-45 0 107.48)" fill="white"/>
      </svg>
