    ...
    <div className="flex dark:bg-[#0f172a] dark:text-white bg-white justify-between px-4 pb-2 pt-[5px] rounded-lg">
      ...
      <button className="w-full text-base flex gap-4 p-2 rounded-lg dark:hover:bg-[#1e293b] hover:bg-gray-200" onClick={changeTheme}>
                  {theme === 'light' ? (
                    ...
                    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <circle cx="12" cy="12" r="6" stroke="#ffffff" strokeWidth="1.5"></circle> <path d="M12 2V3" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M12 21V22" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M22 12L21 12" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M3 12L2 12" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path opacity="0.5" d="M19.0708 4.92969L18.678 5.32252" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path opacity="0.5" d="M5.32178 18.6777L4.92894 19.0706" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path opacity="0.5" d="M19.0708 19.0703L18.678 18.6775" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> <path opacity="0.5" d="M5.32178 5.32227L4.92894 4.92943" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round"></path> </g></svg>
                  )}
                </button>
      </div> */}
      <Menu as="div">
