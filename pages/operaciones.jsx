  ...
  return (
    <div className="flex">
      ...
      <div className="h-screen flex-1 p-7">
        <Header datos={datos} />
        <div className="relative h-10 mt-5 flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-full h-[20%] z-[-2] mx-auto border border-white bg-white">
