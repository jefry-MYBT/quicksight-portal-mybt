...
export default function Glosary({ session }) {
  const [datos, setDatos] = useState(session);
  const contentCard =[
    {
      title:"Data Glosary",
      img:"/gif/glosary/glosary.gif",
      description:"Data Glosary - Quicksight",
      href: "https://us-east-1.quicksight.aws.amazon.com/sn/accounts/111141462942/dashboards/af0f13a0-89e7-42f4-81d9-7ba16ccc386e?directory_alias=bodytechteam"
    }
  ]
      ...
      <div className="h-screen flex-1 p-7">
        ...
        <div className="relative mt-5 flex flex-col md:flex-row dark:bg-[#172554] dark:border-[#172554] dark:text-white md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-full h-[20%] z-[-2] mx-auto border border-white bg-white">
          <div className="w-full md:w-1/3 bg-white dark:bg-[#172554] dark:text-white grid place-items-center">
            <img
              src="/logos/aplicaciones/Logo_Glosary.png"
              alt="software_medico"
              className="w-[50%] h-[100%] mt-[-12%] mg:w-1/5 animate-fade-up"
            />
          </div>
