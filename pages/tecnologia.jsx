...
export default function Tecnologia({ session }) {
  ...
  const contentCard =[
    {
      ...
      href: "https://us-east-1.quicksight.aws.amazon.com/sn/accounts/111141462942/dashboards/c94a6387-9d24-4e63-8c78-892c5cd7daea?directory_alias=bodytechteam"
    },
    {
      title:"Invoice Payment",
      img:"/gif/tecnologia/invoice_payment.gif",
      description:"Invoice Payment - Quicksight",
      href: "https://us-east-1.quicksight.aws.amazon.com/sn/accounts/111141462942/dashboards/5a17d778-cda0-42d9-9c43-05b5e080bdf1?directory_alias=bodytechteam"
    },
  ]
  ...
  return (
    <div className="flex">
      ...
      <div className="h-screen flex-1 p-7">
        <Header datos={datos} />
        <div className="relative mt-5 flex flex-col dark:bg-[#172554] dark:border-[#172554] dark:text-white md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-full h-[20%] z-[-2] mx-auto border border-white bg-white">
          <div className="w-full md:w-1/3 bg-white dark:bg-[#172554] dark:border-[#172554] dark:text-white grid place-items-center">
             <img
              src="/logos/aplicaciones/Logo_Tecnologia.png"
              alt="gif_tecnologia"
              className="w-[50%] h-[85%] mt-[-2%] mg:w-1/5 animate-fade-up"
            /> 
          </div>
          <div className="w-full md:w-2/3 bg-white dark:bg-[#172554] dark:border-[#172554] dark:text-white flex flex-col space-y-2 p-3">
            ...
            <h3 className="font-black dark:bg-[#172554] dark:border-[#172554] dark:text-white text-gray-800 md:text-3xl text-lg animate-fade-up">
              ¡Bienvenid@ a la sección de <span className="text-[#00b8f4]" >TECNOLOGÍA</span>!
            </h3>
          </div>
        </div>
